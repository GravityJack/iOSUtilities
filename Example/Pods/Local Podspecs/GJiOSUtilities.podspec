#
# Be sure to run `pod lib lint GJiOSUtilities.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.version          = "0.1.0"
  s.summary          = "A short description of GJiOSUtilities."
  s.description      = <<-DESC
                       An optional longer description of GJiOSUtilities
